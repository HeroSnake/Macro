...
var app = (function () {
    ...
    const file$5 = "node_modules/svelte-loading-spinners/dist/Jumper.svelte";
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$5, 65, 4, 1192);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$5, 61, 0, 1053);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$3 = "src/Labels.svelte";
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 13, 12, 298);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 11, 4, 223);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    const file$2 = "src/Macros.svelte";
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = text(t4_value);
    			t5 = space();
    			add_location(b, file$2, 7, 12, 158);
    			add_location(div, file$2, 6, 8, 140);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, b);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(t2_value);
    			t3 = text(" g");
    			add_location(b0, file$1, 5, 4, 54);
    			add_location(b1, file$1, 5, 35, 85);
    ...
    class Infos extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { result: 0 });
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 132, 1, 3391);
    			attr_dev(div1, "class", "w-full flex items-center");
    			add_location(div1, file, 137, 2, 3532);
    			attr_dev(div2, "class", "w-full text-center");
    			add_location(div2, file, 140, 2, 3610);
    			attr_dev(div3, "class", "lg:flex lg:items-stretch");
    			add_location(div3, file, 136, 1, 3491);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 144, 1, 3699);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file, 120, 2, 3056);
    			attr_dev(div4, "class", "flex items-center border-b border-teal-500 py-2");
    			add_location(div4, file, 119, 1, 2992);
    			attr_dev(form, "class", "w-full");
    			add_location(form, file, 97, 0, 2432);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(input, "click", /*toggleDarkMode*/ ctx[6], false, false, false),
