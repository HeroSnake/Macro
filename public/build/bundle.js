...
var app = (function () {
    ...
    const file$6 = "node_modules/svelte-loading-spinners/dist/Jumper.svelte";
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 65, 4, 1192);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 61, 0, 1053);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas, file$5, 61, 0, 1737);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Chart_1 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { specs: 0, dark: 1 });
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 13, 12, 298);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 11, 4, 223);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = text(t4_value);
    			t5 = space();
    			add_location(b, file$3, 7, 12, 158);
    			add_location(div, file$3, 6, 8, 140);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, b);
    ...
    // (5:0) {#each Object.values(result.totalNutrients) as Nutrient}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(5:0) {#each Object.values(result.totalNutrients) as Nutrient}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	let each_1_anchor;
    	let each_value = Object.values(/*result*/ ctx[0].totalNutrients);
    	validate_each_argument(each_value);
    	let each_blocks = [];
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*Object, result, parseFloat*/ 1) {
    				each_value = Object.values(/*result*/ ctx[0].totalNutrients);
    				validate_each_argument(each_value);
    				let i;
    ...
    function create_fragment$2(ctx) {
    	let span;
    	let b0;
    	let t0_value = /*result*/ ctx[0].calories + "";
    	let t0;
    	let t1;
    	let b1;
    	let t2_value = /*result*/ ctx[0].totalWeight + "";
    	let t2;
    	let t3;
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(t2_value);
    			t3 = text(" g");
    			add_location(b0, file$2, 5, 4, 54);
    			add_location(b1, file$2, 5, 35, 85);
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*result*/ 1 && t0_value !== (t0_value = /*result*/ ctx[0].calories + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*result*/ 1 && t2_value !== (t2_value = /*result*/ ctx[0].totalWeight + "")) set_data_dev(t2, t2_value);
    		},
    		i: noop$1,
    		o: noop$1,
    		d: function destroy(detaching) {
    ...
    /* src/Toggle.svelte generated by Svelte v3.38.3 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label, file$1, 15, 4, 373);
    			attr_dev(div3, "class", "flex items-center justify-center w-full mb-4");
    			add_location(div3, file$1, 14, 0, 310);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(input, "click", /*addDarkModeSelector*/ ctx[0], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop$1,
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ dark, addDarkModeSelector });
    	...
    	return [addDarkModeSelector, dark];
    }

    class Toggle extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { dark: 1 });
    		...
    		if (/*dark*/ ctx[1] === undefined && !("dark" in props)) {
    			console.warn("<Toggle> was created without expected prop 'dark'");
    		}
    	}
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 107, 1, 2635);
    			attr_dev(div1, "class", "w-full flex items-center");
    			add_location(div1, file, 112, 2, 2776);
    			attr_dev(div2, "class", "w-full text-center");
    			add_location(div2, file, 115, 2, 2854);
    			attr_dev(div3, "class", "lg:flex lg:items-stretch");
    			add_location(div3, file, 111, 1, 2735);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 119, 1, 2943);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment(ctx) {
    	...
    	function toggledark_dark_binding(value) {
    		/*toggledark_dark_binding*/ ctx[6](value);
    	}

    	let toggledark_props = {};

    	if (/*dark*/ ctx[4] !== void 0) {
    		toggledark_props.dark = /*dark*/ ctx[4];
    	}

    	toggledark = new Toggle({ props: toggledark_props, $$inline: true });
    	binding_callbacks.push(() => bind(toggledark, "dark", toggledark_dark_binding));
    	let if_block0 = /*result*/ ctx[0] && create_if_block_1(ctx);
    	let if_block1 = /*isLoading*/ ctx[2] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file, 95, 2, 2300);
    			attr_dev(div, "class", "flex items-center border-b border-teal-500 py-2");
    			add_location(div, file, 94, 1, 2236);
    			attr_dev(form, "class", "w-full");
    			add_location(form, file, 92, 0, 2180);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(toggledark, form, null);
    			append_dev(form, t0);
    			append_dev(form, div);
    		...
    		p: function update(ctx, [dirty]) {
    			const toggledark_changes = {};

    			if (!updating_dark && dirty & /*dark*/ 16) {
    				updating_dark = true;
    				toggledark_changes.dark = /*dark*/ ctx[4];
    				add_flush_callback(() => updating_dark = false);
    			}

    			toggledark.$set(toggledark_changes);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const getData = async () => {
    		...
    		$$invalidate(1, ing = ing.split(","));
    		let json = { ingr: ing };

    		$$invalidate(0, result = await fetch("https://api.edamam.com/api/nutrition-details?app_id=690348ca&app_key=bedbeeb0e08003fce6d13408ccaf231d", {
    			method: "POST",
