...
var app = (function () {
    ...
    const file$a = "node_modules/svelte-awesome/components/svg/Polygon.svelte";
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(polygon, file$a, 0, 0, 0);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* node_modules/svelte-loading-spinners/dist/Jumper.svelte generated by Svelte v3.38.3 */
    const file$7 = "node_modules/svelte-loading-spinners/dist/Jumper.svelte";
    ...
    // (65:2) {#each range(3, 1) as version}
    function create_each_block$3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(65:2) {#each range(3, 1) as version}",
    		ctx
    	});
    ...
    /* src/ChartCompare.svelte generated by Svelte v3.38.3 */
    const file$6 = "src/ChartCompare.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(canvas, "id", "chartRadar");
    			add_location(canvas, file$6, 84, 0, 2500);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("ChartCompare", slots, []);
    	let { results } = $$props, { ingredients } = $$props, { dark } = $$props;
    	...
    	const setChart = () => {
    		$$invalidate(3, chartRadar = new Chart(document.getElementById("chartRadar"), radarConfig));
    	};

    	setTimeout(setChart, 20);
    	const writable_props = ["results", "ingredients", "dark"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<ChartCompare> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("chartRadar" in $$props) $$invalidate(3, chartRadar = $$props.chartRadar);
    		if ("colors" in $$props) colors = $$props.colors;
    		if ("radarConfig" in $$props) radarConfig = $$props.radarConfig;
    		if ("updateCharts" in $$props) $$invalidate(8, updateCharts = $$props.updateCharts);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*dark, chartRadar*/ 12) {
    			(updateCharts(chartRadar));
    		}
    	};

    	return [results, ingredients, dark, chartRadar];
    }

    class ChartCompare extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { results: 0, ingredients: 1, dark: 2 });

    		dispatch_dev("SvelteRegisterComponent", {
    			component: this,
    			tagName: "ChartCompare",
    			options,
    			id: create_fragment$6.name
    		});
    		...
    		if (/*results*/ ctx[0] === undefined && !("results" in props)) {
    			console.warn("<ChartCompare> was created without expected prop 'results'");
    		}

    		if (/*ingredients*/ ctx[1] === undefined && !("ingredients" in props)) {
    			console.warn("<ChartCompare> was created without expected prop 'ingredients'");
    		}

    		if (/*dark*/ ctx[2] === undefined && !("dark" in props)) {
    			console.warn("<ChartCompare> was created without expected prop 'dark'");
    		}
    	}

    	get results() {
    		throw new Error("<ChartCompare>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set results(value) {
    		throw new Error("<ChartCompare>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    /* src/Chart.svelte generated by Svelte v3.38.3 */
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			canvas = element("canvas");
    			attr_dev(canvas, "id", canvas_id_value = "chartDonut" + /*i*/ ctx[0]);
    			add_location(canvas, file$5, 67, 0, 1877);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*i*/ 1 && canvas_id_value !== (canvas_id_value = "chartDonut" + /*i*/ ctx[0])) {
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	let { result } = $$props, { dark } = $$props, { i } = $$props;
    	...
    	let updateCharts = chartDonut => {
    		if (chartDonut) {
    			chartDonut.options.plugins.legend.labels.color = dark ? "white" : "black";
    			chartDonut.data.datasets[0].borderColor = dark ? "#1f2937" : "white";
    			chartDonut.update();
    		} else {
    			return false;
    		}
    	...
    	const setChart = () => {
    		$$invalidate(3, chartDonut = new Chart(document.getElementById("chartDonut" + i), donutConfig));
    	};

    	setTimeout(setChart, 20);
    	const writable_props = ["result", "dark", "i"];
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("dark" in $$props) $$invalidate(2, dark = $$props.dark);
    		if ("i" in $$props) $$invalidate(0, i = $$props.i);
    		if ("specs" in $$props) specs = $$props.specs;
    		if ("specsTitle" in $$props) specsTitle = $$props.specsTitle;
    		if ("specsColors" in $$props) specsColors = $$props.specsColors;
    		if ("specsValues" in $$props) specsValues = $$props.specsValues;
    		if ("chartDonut" in $$props) $$invalidate(3, chartDonut = $$props.chartDonut);
    		if ("donutConfig" in $$props) donutConfig = $$props.donutConfig;
    		if ("updateCharts" in $$props) $$invalidate(9, updateCharts = $$props.updateCharts);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*dark, chartDonut*/ 12) {
    			(updateCharts(chartDonut));
    		}
    	};

    	return [i, result, dark, chartDonut];
    }

    class Chart_1 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { result: 1, dark: 2, i: 0 });
    		...
    		if (/*i*/ ctx[0] === undefined && !("i" in props)) {
    			console.warn("<Chart> was created without expected prop 'i'");
    		}
    	}
    ...
    /* src/Labels.svelte generated by Svelte v3.38.3 */

    const file$4 = "src/Labels.svelte";
    ...
    // (13:8) {#each labelList[0] as label}
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			attr_dev(div, "class", "text-sm font-medium bg-" + /*labelList*/ ctx[2][1] + "-100 py-1 px-2 rounded text-" + /*labelList*/ ctx[2][1] + "-500 align-middle hover:bg-" + /*labelList*/ ctx[2][1] + "-200 hover:ring-2 hover:ring-" + /*labelList*/ ctx[2][1] + "-500");
    			add_location(div, file$4, 13, 12, 311);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(13:8) {#each labelList[0] as label}",
    		ctx
    	});
    ...
    // (11:0) {#each labelsList as labelList}
    function create_each_block$2(ctx) {
    	let div;
    	let t;
    	let each_value_1 = /*labelList*/ ctx[2][0];
    	validate_each_argument(each_value_1);
    	let each_blocks = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			attr_dev(div, "class", "scrollmenu");
    			add_location(div, file$4, 11, 4, 236);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*labelsList*/ 1) {
    				each_value_1 = /*labelList*/ ctx[2][0];
    				validate_each_argument(each_value_1);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(11:0) {#each labelsList as labelList}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	let each_1_anchor;
    	let each_value = /*labelsList*/ ctx[0];
    	validate_each_argument(each_value);
    	let each_blocks = [];
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ result, labelsList });

    	$$self.$inject_state = $$props => {
    		if ("result" in $$props) $$invalidate(1, result = $$props.result);
    		if ("labelsList" in $$props) $$invalidate(0, labelsList = $$props.labelsList);
    	};
    ...
    class Labels extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*result*/ ctx[1] === undefined && !("result" in props)) {
    			console.warn("<Labels> was created without expected prop 'result'");
    		}
    	}
    ...
    /* src/Macros.svelte generated by Svelte v3.38.3 */

    const { Object: Object_1$1 } = globals;
    const file$3 = "src/Macros.svelte";
    ...
    // (6:4) {#if Nutrient.quantity > 0}
    function create_if_block$1(ctx) {
    	let div;
    	let b;
    	let t0_value = /*Nutrient*/ ctx[1].label + "";
    	let t0;
    	let t1;
    	let t2_value = parseFloat(/*Nutrient*/ ctx[1].quantity).toFixed(2) + "";
    	let t2;
    	let t3;
    	let t4_value = /*Nutrient*/ ctx[1].unit + "";
    	let t4;
    	let t5;
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = text(t4_value);
    			t5 = space();
    			add_location(b, file$3, 7, 12, 162);
    			add_location(div, file$3, 6, 8, 144);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, b);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*result*/ 1 && t0_value !== (t0_value = /*Nutrient*/ ctx[1].label + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*result*/ 1 && t2_value !== (t2_value = parseFloat(/*Nutrient*/ ctx[1].quantity).toFixed(2) + "")) set_data_dev(t2, t2_value);
    			if (dirty & /*result*/ 1 && t4_value !== (t4_value = /*Nutrient*/ ctx[1].unit + "")) set_data_dev(t4, t4_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(6:4) {#if Nutrient.quantity > 0}",
    		ctx
    	});
    ...
    // (5:0) {#each Object.values(result.data.totalNutrients) as Nutrient}
    function create_each_block$1(ctx) {
    	let if_block_anchor;
    	let if_block = /*Nutrient*/ ctx[1].quantity > 0 && create_if_block$1(ctx);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(5:0) {#each Object.values(result.data.totalNutrients) as Nutrient}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	let each_1_anchor;
    	let each_value = Object.values(/*result*/ ctx[0].data.totalNutrients);
    	validate_each_argument(each_value);
    	let each_blocks = [];
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*Object, result, parseFloat*/ 1) {
    				each_value = Object.values(/*result*/ ctx[0].data.totalNutrients);
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("Macros", slots, []);
    	let { result } = $$props;
    	const writable_props = ["result"];

    	Object_1$1.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Macros> was created with unknown prop '${key}'`);
    	});
    ...
    class Macros extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		...
    		if (/*result*/ ctx[0] === undefined && !("result" in props)) {
    			console.warn("<Macros> was created without expected prop 'result'");
    		}
    	}

    	get result() {
    		throw new Error("<Macros>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set result(value) {
    		throw new Error("<Macros>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }

    /* src/Infos.svelte generated by Svelte v3.38.3 */

    const file$2 = "src/Infos.svelte";

    function create_fragment$2(ctx) {
    	let span;
    	let b0;
    	let t0_value = /*result*/ ctx[0].data.calories + "";
    	let t0;
    	let t1;
    	let b1;
    	let t2_value = /*result*/ ctx[0].data.totalWeight + "";
    	let t2;
    	let t3;
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(t2_value);
    			t3 = text(" g");
    			add_location(b0, file$2, 5, 4, 53);
    			add_location(b1, file$2, 5, 40, 89);
    			add_location(span, file$2, 4, 0, 42);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*result*/ 1 && t0_value !== (t0_value = /*result*/ ctx[0].data.calories + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*result*/ 1 && t2_value !== (t2_value = /*result*/ ctx[0].data.totalWeight + "")) set_data_dev(t2, t2_value);
    		},
    		i: noop$1,
    		o: noop$1,
    		d: function destroy(detaching) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("Infos", slots, []);
    	let { result } = $$props;
    	const writable_props = ["result"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Infos> was created with unknown prop '${key}'`);
    	});
    ...
    class Infos extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		...
    		if (/*result*/ ctx[0] === undefined && !("result" in props)) {
    			console.warn("<Infos> was created without expected prop 'result'");
    		}
    	}

    	get result() {
    		throw new Error("<Infos>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set result(value) {
    		throw new Error("<Infos>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }

    /* src/Result.svelte generated by Svelte v3.38.3 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div0 = element("div");
    			create_component(infos.$$.fragment);
    			t0 = space();
    			...
    			attr_dev(div0, "class", div0_class_value = "text-center leading-loose " + (/*compare*/ ctx[2] ? "" : "text-2xl"));
    			add_location(div0, file$1, 9, 0, 212);
    			attr_dev(div1, "class", "w-full flex items-center");
    			add_location(div1, file$1, 14, 4, 372);
    			attr_dev(div2, "class", div2_class_value = "w-full text-center " + (/*compare*/ ctx[2] ? "text-xs" : ""));
    			add_location(div2, file$1, 17, 4, 464);
    			attr_dev(div3, "class", "lg:flex lg:items-stretch");
    			add_location(div3, file$1, 13, 0, 329);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(infos, div0, null);
    			insert_dev(target, t0, anchor);
    			...
    			mount_component(macros, div2, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    			const infos_changes = {};
    			if (dirty & /*result*/ 1) infos_changes.result = /*result*/ ctx[0];
    			infos.$set(infos_changes);

    			if (!current || dirty & /*compare*/ 4 && div0_class_value !== (div0_class_value = "text-center leading-loose " + (/*compare*/ ctx[2] ? "" : "text-2xl"))) {
    			...
    			if (dirty & /*dark*/ 2) chart_changes.dark = /*dark*/ ctx[1];
    			if (dirty & /*i*/ 8) chart_changes.i = /*i*/ ctx[3];
    			chart.$set(chart_changes);
    			const macros_changes = {};
    			if (dirty & /*result*/ 1) macros_changes.result = /*result*/ ctx[0];
    			macros.$set(macros_changes);

    			if (!current || dirty & /*compare*/ 4 && div2_class_value !== (div2_class_value = "w-full text-center " + (/*compare*/ ctx[2] ? "text-xs" : ""))) {
    				attr_dev(div2, "class", div2_class_value);
    			}
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(infos.$$.fragment, local);
    		...
    		o: function outro(local) {
    			transition_out(infos.$$.fragment, local);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["result", "dark", "compare", "i"];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("compare" in $$props) $$invalidate(2, compare = $$props.compare);
    	...
    	return [result, dark, compare, i];
    }

    class Result extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { result: 0, dark: 1, compare: 2, i: 3 });
    		...
    		if (/*dark*/ ctx[1] === undefined && !("dark" in props)) {
    			console.warn("<Result> was created without expected prop 'dark'");
    		}

    		if (/*compare*/ ctx[2] === undefined && !("compare" in props)) {
    			console.warn("<Result> was created without expected prop 'compare'");
    		}

    		if (/*i*/ ctx[3] === undefined && !("i" in props)) {
    			console.warn("<Result> was created without expected prop 'i'");
    		}
    	}
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(textarea, "class", textarea_class_value = "appearance-none bg-transparent border-none w-full dark:text-white text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none text-center focus:underline " + (/*compare*/ ctx[3] ? "text-base" : "text-xl"));
    			attr_dev(textarea, "placeholder", "Ingredients #2");
    			add_location(textarea, file, 150, 3, 4316);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, textarea, anchor);
    			set_input_value(textarea, /*ingredients*/ ctx[0][1]);

    			if (!mounted) {
    				dispose = [
    					listen_dev(textarea, "change", /*change_handler_1*/ ctx[11], false, false, false),
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*compare*/ 8 && textarea_class_value !== (textarea_class_value = "appearance-none bg-transparent border-none w-full dark:text-white text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none text-center focus:underline " + (/*compare*/ ctx[3] ? "text-base" : "text-xl"))) {
    ...
    // (166:1) {#if !isEmptyObject(results[0].data)}
    function create_if_block_1(ctx) {
    	let show_if = /*compare*/ ctx[3] && !/*isEmptyObject*/ ctx[8](/*results*/ ctx[4][1].data);
    	let t;
    	let div;
    	let current;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 169, 2, 4938);
    		},
    		m: function mount(target, anchor) {
    			if (if_block) if_block.m(target, anchor);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*compare, results*/ 24) show_if = /*compare*/ ctx[3] && !/*isEmptyObject*/ ctx[8](/*results*/ ctx[4][1].data);

    			if (show_if) {
    				if (if_block) {
    					if_block.p(ctx, dirty);

    					if (dirty & /*compare, results*/ 24) {
    						transition_in(if_block, 1);
    					}
    				} else {
    			...
    			if (dirty & /*compare, results, dark, isEmptyObject*/ 284) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(166:1) {#if !isEmptyObject(results[0].data)}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 161, 1, 4680);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    // (167:2) {#if compare && !isEmptyObject(results[1].data)}
    function create_if_block_3(ctx) {
    	let chartcompare;
    	let current;

    	chartcompare = new ChartCompare({
    			props: {
    				results: /*results*/ ctx[4],
    	...
    	const block = {
    		c: function create() {
    			create_component(chartcompare.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(chartcompare, target, anchor);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    			const chartcompare_changes = {};
    			if (dirty & /*results*/ 16) chartcompare_changes.results = /*results*/ ctx[4];
    			if (dirty & /*ingredients*/ 1) chartcompare_changes.ingredients = /*ingredients*/ ctx[0];
    			if (dirty & /*dark*/ 4) chartcompare_changes.dark = /*dark*/ ctx[2];
    			chartcompare.$set(chartcompare_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(chartcompare.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(chartcompare.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(chartcompare, detaching);
    		}
    	};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(167:2) {#if compare && !isEmptyObject(results[1].data)}",
    		ctx
    	});
    ...
    // (173:5) {#if !isEmptyObject(result.data) && (i == 0 || compare)}
    function create_if_block_2(ctx) {
    	...
    	result = new Result({
    			props: {
    				result: /*result*/ ctx[19],
    				dark: /*dark*/ ctx[2],
    				compare: /*compare*/ ctx[3],
    				i: /*i*/ ctx[21]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*results*/ 16) result_changes.result = /*result*/ ctx[19];
    			if (dirty & /*dark*/ 4) result_changes.dark = /*dark*/ ctx[2];
    			if (dirty & /*compare*/ 8) result_changes.compare = /*compare*/ ctx[3];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(173:5) {#if !isEmptyObject(result.data) && (i == 0 || compare)}",
    		ctx
    	});
    ...
    // (171:3) {#each results as result, i}
    function create_each_block(ctx) {
    	let div;
    	let show_if = !/*isEmptyObject*/ ctx[8](/*result*/ ctx[19].data) && (/*i*/ ctx[21] == 0 || /*compare*/ ctx[3]);
    	let t;
    	let div_class_value;
    	let current;
    	...
    	const block = {
    		c: function create() {
    			...
    			if (if_block) if_block.c();
    			t = space();
    			attr_dev(div, "class", div_class_value = "flex flex-col " + (/*compare*/ ctx[3] ? "w-1/2 px-2" : "w-full"));
    			add_location(div, file, 171, 4, 4993);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*results, compare*/ 24) show_if = !/*isEmptyObject*/ ctx[8](/*result*/ ctx[19].data) && (/*i*/ ctx[21] == 0 || /*compare*/ ctx[3]);

    			if (show_if) {
    				if (if_block) {
    					if_block.p(ctx, dirty);

    					if (dirty & /*results, compare*/ 24) {
    						transition_in(if_block, 1);
    					}
    				} else {
    			...
    			if (!current || dirty & /*compare*/ 8 && div_class_value !== (div_class_value = "flex flex-col " + (/*compare*/ ctx[3] ? "w-1/2 px-2" : "w-full"))) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(171:3) {#each results as result, i}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	icon = new Icon({
    			props: { data: faCompressAlt, scale: 2 },
    			$$inline: true
    		});

    	let if_block0 = /*compare*/ ctx[3] && create_if_block_4(ctx);
    	const if_block_creators = [create_if_block, create_if_block_1];
    	const if_blocks = [];

    	function select_block_type(ctx, dirty) {
    		if (/*isLoading*/ ctx[1]) return 0;
    		if (dirty & /*results*/ 16) show_if = !!!/*isEmptyObject*/ ctx[8](/*results*/ ctx[4][0].data);
    		if (show_if) return 1;
    		return -1;
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 124, 4, 3427);
    			attr_dev(div0, "class", "block bg-gray-600 w-14 h-8 rounded-full");
    			add_location(div0, file, 131, 4, 3554);
    			attr_dev(div1, "class", "dot absolute left-1 top-1 bg-white w-6 h-6 rounded-full transition");
    			add_location(div1, file, 133, 4, 3631);
    			attr_dev(div2, "class", "relative");
    			add_location(div2, file, 122, 3, 3381);
    			attr_dev(label, "for", "toggleB");
    			attr_dev(label, "class", "flex items-center cursor-pointer");
    			add_location(label, file, 120, 2, 3296);
    			attr_dev(button, "type", "button");
    			attr_dev(button, "class", "flex items-center font-bold py-1 px-2 mt-2 rounded");
    			add_location(button, file, 138, 2, 3746);
    			attr_dev(div3, "class", "flex items-center justify-center flex-col w-full mb-4");
    			add_location(div3, file, 119, 1, 3226);
    			attr_dev(textarea, "class", textarea_class_value = "appearance-none bg-transparent border-none w-full dark:text-white text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none text-center focus:underline " + (/*compare*/ ctx[3] ? "text-base" : "text-xl"));
    			attr_dev(textarea, "placeholder", "Ingredients #1");
    			add_location(textarea, file, 143, 2, 3980);
    			attr_dev(div4, "class", "flex items-center border-b border-teal-500 py-2");
    			add_location(div4, file, 142, 1, 3916);
    			attr_dev(form, "class", "w-full");
    			add_location(form, file, 117, 0, 3184);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(textarea, /*ingredients*/ ctx[0][0]);
    			append_dev(div4, t4);
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(input, "click", /*toggleDarkMode*/ ctx[5], false, false, false),
    					listen_dev(button, "click", /*toggleCompare*/ ctx[7], false, false, false),
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*compare*/ 8 && textarea_class_value !== (textarea_class_value = "appearance-none bg-transparent border-none w-full dark:text-white text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none text-center focus:underline " + (/*compare*/ ctx[3] ? "text-base" : "text-xl"))) {
    				attr_dev(textarea, "class", textarea_class_value);
    			}
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let ingredients = [
    		localStorage.getItem("ingredients0")
    		? localStorage.getItem("ingredients0")
    		: "100 g rice, 2 banana",
    		localStorage.getItem("ingredients1")
    		? localStorage.getItem("ingredients1")
    		: "100 g pasta, 100 g courgette"
    	];
    		...
    		for (const nutrient of Object.values(results[index].data.totalNutrients)) {
    			if (nutrient.unit != "kcal") {
    				...
    				if (other && !forbidden_elements.includes(nutrient.label)) {
    					$$invalidate(4, results[index].specs[4][2] += quantity, results);
    				}
    			}
    		}
    	};
    	...
    	const getData = async index => {
    		$$invalidate(4, results[index].data = {}, results);
    		...
    		$$invalidate(
    			4,
    			results[index].data = await fetch("https://api.edamam.com/api/nutrition-details?app_id=690348ca&app_key=bedbeeb0e08003fce6d13408ccaf231d", {
    				method: "POST",
    	...
    	const change_handler = () => handleClick(0);

    	function textarea_input_handler() {
    		ingredients[0] = this.value;
    		$$invalidate(0, ingredients);
    	}

    	const change_handler_1 = () => handleClick(1);

    	function textarea_input_handler_1() {
    		ingredients[1] = this.value;
    		$$invalidate(0, ingredients);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("dark" in $$props) $$invalidate(2, dark = $$props.dark);
    		if ("compare" in $$props) $$invalidate(3, compare = $$props.compare);
