...
var app = (function () {
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 65, 4, 1192);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 61, 0, 1053);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block_1(ctx) {
    	...
    	let t8;
    	let each4_anchor;
    	let each_value_4 = Object.values(/*result*/ ctx[0].totalNutrients);
    	...
    	let each_value_3 = /*result*/ ctx[0].dietLabels;
    	...
    	let each_value_2 = /*result*/ ctx[0].healthLabels;
    	...
    	let each_value_1 = /*result*/ ctx[0].cautions;
    	validate_each_argument(each_value_1);
    	let each_blocks_1 = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			each4_anchor = empty();
    			add_location(b0, file, 67, 3, 1459);
    			add_location(b1, file, 67, 34, 1490);
    			add_location(div0, file, 66, 2, 1450);
    			attr_dev(div1, "class", "container-flex");
    			add_location(div1, file, 69, 2, 1531);
    			attr_dev(div2, "class", "scrollmenu");
    			add_location(div2, file, 89, 2, 1975);
    			attr_dev(div3, "class", "scrollmenu");
    			add_location(div3, file, 96, 2, 2128);
    			attr_dev(div4, "class", "scrollmenu");
    			add_location(div4, file, 103, 2, 2289);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*specs, Object, result, parseFloat*/ 9) {
    				each_value_4 = Object.values(/*result*/ ctx[0].totalNutrients);
    				validate_each_argument(each_value_4);
    				let i;
    			...
    			if (dirty & /*result*/ 1) {
    				each_value_3 = /*result*/ ctx[0].dietLabels;
    				validate_each_argument(each_value_3);
    				let i;
    			...
    			if (dirty & /*result*/ 1) {
    				each_value_2 = /*result*/ ctx[0].healthLabels;
    				validate_each_argument(each_value_2);
    				let i;
    			...
    			if (dirty & /*result*/ 1) {
    				each_value_1 = /*result*/ ctx[0].cautions;
    				validate_each_argument(each_value_1);
    				let i;
    ...
    // (73:5) {#if spec[0] == Nutrient.label}
    function create_if_block_3(ctx) {
    	let div;
    	let h2;
    	let t0_value = /*Nutrient*/ ctx[10].label + "";
    	let t0;
    	let t1;
    	let p;
    	let t2_value = parseFloat(/*Nutrient*/ ctx[10].quantity).toFixed(2) + "";
    	let t2;
    	let t3;
    	let t4_value = /*Nutrient*/ ctx[10].unit + "";
    	let t4;
    	let t5;
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = text(t4_value);
    			t5 = space();
    			add_location(h2, file, 77, 7, 1776);
    			add_location(p, file, 80, 7, 1826);
    			attr_dev(div, "class", "infobulle");
    			set_style(div, "background-color", /*spec*/ ctx[24][1]);
    			add_location(div, file, 73, 6, 1689);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h2);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*result*/ 1 && t0_value !== (t0_value = /*Nutrient*/ ctx[10].label + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*result*/ 1 && t2_value !== (t2_value = parseFloat(/*Nutrient*/ ctx[10].quantity).toFixed(2) + "")) set_data_dev(t2, t2_value);
    			if (dirty & /*result*/ 1 && t4_value !== (t4_value = /*Nutrient*/ ctx[10].unit + "")) set_data_dev(t4, t4_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(73:5) {#if spec[0] == Nutrient.label}",
    		ctx
    	});
    ...
    // (72:4) {#each specs as spec}
    function create_each_block_5(ctx) {
    	let if_block_anchor;
    	let if_block = /*spec*/ ctx[24][0] == /*Nutrient*/ ctx[10].label && create_if_block_3(ctx);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (/*spec*/ ctx[24][0] == /*Nutrient*/ ctx[10].label) {
    				if (if_block) {
    					if_block.p(ctx, dirty);
    				} else {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(72:4) {#each specs as spec}",
    		ctx
    	});
    ...
    // (71:3) {#each Object.values(result.totalNutrients) as Nutrient}
    function create_each_block_4(ctx) {
    	let each_1_anchor;
    	let each_value_5 = /*specs*/ ctx[3];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(71:3) {#each Object.values(result.totalNutrients) as Nutrient}",
    		ctx
    	});
    ...
    // (91:3) {#each result.dietLabels as dietLabel}
    function create_each_block_3(ctx) {
    	let div;
    	let t0_value = /*dietLabel*/ ctx[19] + "";
    	let t0;
    	let t1;
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(div, "class", "labels dietLabels");
    			add_location(div, file, 91, 4, 2046);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*result*/ 1 && t0_value !== (t0_value = /*dietLabel*/ ctx[19] + "")) set_data_dev(t0, t0_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(91:3) {#each result.dietLabels as dietLabel}",
    		ctx
    	});
    ...
    // (98:3) {#each result.healthLabels as healthLabel}
    function create_each_block_2(ctx) {
    	let div;
    	let t0_value = /*healthLabel*/ ctx[16] + "";
    	let t0;
    	let t1;
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(div, "class", "labels healthLabels");
    			add_location(div, file, 98, 4, 2203);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*result*/ 1 && t0_value !== (t0_value = /*healthLabel*/ ctx[16] + "")) set_data_dev(t0, t0_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(98:3) {#each result.healthLabels as healthLabel}",
    		ctx
    	});
    ...
    // (105:3) {#each result.cautions as caution}
    function create_each_block_1(ctx) {
    	let div;
    	let t0_value = /*caution*/ ctx[13] + "";
    	let t0;
    	let t1;
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(div, "class", "labels cautions");
    			add_location(div, file, 105, 4, 2356);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*result*/ 1 && t0_value !== (t0_value = /*caution*/ ctx[13] + "")) set_data_dev(t0, t0_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(105:3) {#each result.cautions as caution}",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = text(t4_value);
    			t5 = space();
    			add_location(b, file, 113, 5, 2537);
    			add_location(div, file, 112, 4, 2526);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, b);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(112:3) {#if Nutrient.quantity > 0}",
    		ctx
    	});
    ...
    // (111:2) {#each Object.values(result.totalNutrients) as Nutrient}
    function create_each_block(ctx) {
    	let if_block_anchor;
    	let if_block = /*Nutrient*/ ctx[10].quantity > 0 && create_if_block_2(ctx);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(111:2) {#each Object.values(result.totalNutrients) as Nutrient}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 122, 2, 2696);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			if (default_slot) default_slot.c();
    			attr_dev(textarea, "class", "appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none");
    			attr_dev(textarea, "placeholder", "Ingredients");
    			attr_dev(textarea, "id", "story");
    			attr_dev(textarea, "name", "story");
    			add_location(textarea, file, 55, 3, 1169);
    			attr_dev(div, "class", "flex items-center border-b border-teal-500 py-2");
    			add_location(div, file, 54, 2, 1104);
    			attr_dev(form, "class", "w-full max-w-sm");
    			add_location(form, file, 53, 1, 1071);
    			add_location(body, file, 52, 0, 1063);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
